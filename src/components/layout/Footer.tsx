...
export default function Footer() {
  return (
     <a href="about" >
    <footer className="flex flex-col justify-between min-h-screen bg-gradient-to-br from-[#1C1B3E] to-[#141229] text-gray-300 min-h-[60vh] w-full relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="./TeamSection" className="hover:text-white">TeamSection</a></li>
